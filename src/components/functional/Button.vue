...
const buttonVariants = cva<ButtonStyleVariants>(
  ...
  ],
  {
    ...
    compoundVariants: [
      ...
      { type: "icon", size: "xs", class: "p-0 h-7 min-h-[28px] w-7 min-w-[28px]"},
      { type: "icon", size: "sm", class: "p-0 h-8 min-h-[32px] w-8 min-w-[32px]" },
      { type: "icon", size: "md", class: "p-0 h-9 min-h-[36px] w-9 min-w-[36px]" },
      { type: "icon", size: "lg", class: "p-0 h-11 min-h-[44px] w-11 min-w-[44px]" },
      { type: "icon", size: "xl", class: "p-0 h-12 min-h-[48px] w-12 min-w-[48px]" },
    ],
    defaultVariants: {
      mode: "primary",
      color: "neutral",
